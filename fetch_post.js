fetch("https://cn.bing.com/ttranslatev3?isVertical=1&&IG=F943110341A44203A435A460E25E17EF&IID=translator.5026", {
    "headers": {
        "accept": "*/*",
    ...
    "body": "fromLang=en&to=zh-Hans&text=jack%0A%0A&tryFetchingGenderDebiasedTranslatio ns=true&token=4F5tprLYLplF2E_g_4D-0swaZvJkbfkb&key=1764344858538",
    "method": "POST"
}).then(r => r.json())
    .then(j => {
        console.log(j)
